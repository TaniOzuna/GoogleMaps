...
import com.example.googlemapsgoogleplaces.googlemapsgoogleplaces.models.PlaceInfo;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
 GoogleApiClient.OnConnectionFailedListener{
    ...
    private void moveCamera(LatLng latLng, float zoom,PlaceInfo placeInfo){
        Log.d(TAG, "moveCamera: movingthe camera to: last: " + latLng.latitude + ", lng: " + latLng.longitude);
        ...
        if(placeInfo != null){
            try{
                String snippet = "Address: " + placeInfo.getAddress() + "\n" +
                        ...
                        "Website: " + placeInfo.getWebisteUri() + "\n" +
    ...
    private AdapterView.OnItemClickListener mAutoCompleteClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            ...
            PendingResult<PlaceBuffer> placeResult = Places.GeoDataApi
                    .getPlaceById(mGoogleApiClient,placedId);
            placeResult.setResultCallback(mUpdatePlaceDetailsCallback);
        }
    };
    ...
    private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback = new ResultCallback<PlaceBuffer>() {
        ...
        public void onResult(@NonNull PlaceBuffer places) {
            ...
            try{
                ...
                //Log.d(TAG, "onResult: name: " + place.getAttributions());
                ...
                mPlace.setWebisteUri(place.getWebsiteUri());
